<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Modificar_Cliente.aspx.cs" Inherits="chn_prueba.Modificar_Usuario" %>
    ...
    <div class="container well contenedor">
        ...
        <form id="form1" runat="server" class="form-horizontal">   
            <div class="form-group">
                    <asp:Label ID="lblcuiseleccionar" runat="server" Text="Seleccion CUI" CssClass="control-label col-sm-2"></asp:Label>
                    <div class="col-sm-12">
                        <asp:DropDownList ID="cbb_cui" runat="server" OnSelectedIndexChanged="cbb_cliente_SelectedIndexChanged" CssClass="form-control"></asp:DropDownList>
                    </div>
                </div>
            <div class="form-group">
                     <asp:Button ID="btnbuscar" runat="server" Text="Buscar" OnClick="btnbuscar_Click" CssClass="form-control btn btn-primary"  ></asp:Button>
                </div>
                 <div class="form-group">
